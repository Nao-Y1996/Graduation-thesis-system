...
def gripper_operating(data):
	...
	#sensor_path = '/home/naoyamada/catkin_ws3/src/hsr_handing/script/csv/raw_data.csv'
	...
	#print('---------Fuzzy----------')
        ...
        if pose_num == 0.0:
            force_path = '/home/naoyamada/catkin_ws3/src/hsr_handing/script/csv/force_yz/force_data_sit.csv'
        if pose_num == 1.0:
            force_path = '/home/naoyamada/catkin_ws3/src/hsr_handing/script/csv/force_yz/force_data_stand.csv'
        if pose_num == 2.0:
            force_path = '/home/naoyamada/catkin_ws3/src/hsr_handing/script/csv/force_yz/force_data_cross.csv'
        if pose_num == 3.0:
            force_path = '/home/naoyamada/catkin_ws3/src/hsr_handing/script/csv/force_yz/force_data_unknown.csv'
...
if __name__ == '__main__':
	...
	sub_pose = Sub_Pose_estimation()
        ...
        sensor_path = '/home/naoyamada/catkin_ws3/src/hsr_handing/script/csv/sensor_data.csv'
	#force_path = '/home/naoyamada/catkin_ws3/src/hsr_handing/script/csv/force_data.csv'
	os.remove(sensor_path)
        f= open(sensor_path, 'w')
        f.close
